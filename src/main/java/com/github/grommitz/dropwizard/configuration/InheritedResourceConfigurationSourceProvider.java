...
public class InheritedResourceConfigurationSourceProvider<T extends Configuration> implements ConfigurationSourceProvider {

	private Class<T> configType;

	public InheritedResourceConfigurationSourceProvider(Class<T> configType) {
